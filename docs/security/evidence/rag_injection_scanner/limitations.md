...
- Real LlamaFirewall backend behavior is not proven unless a compatible dependency is installed and the tests/demos are run in that environment.
- AgentShield is not added by this change.
