...
- **Why read it:** Establishes the repository's top-level portfolio positioning.
- **What it proves:** The project is framed as a RAG and autonomous-agent security-readiness portfolio with explicit status boundaries.
- **What it does not prove:** Production readiness, enterprise readiness, external validation, compliance certification, or live enforcement.

## 2. [`PORTFOLIO_CASE_STUDY.md`](../../PORTFOLIO_CASE_STUDY.md)

- **Why read it:** Provides the final reviewer-facing narrative and security-readiness case study.
- **What it proves:** The portfolio has a coherent evidence-based story and known limitations.
- **What it does not prove:** That the underlying application is fully staged, production-ready, or externally assessed.

## 3. [`CLAIM_BOUNDARY.md`](../../CLAIM_BOUNDARY.md)

- **Why read it:** Defines safe claims, forbidden claims, and status language.
- **What it proves:** The repository has explicit claim-boundary governance.
- **What it does not prove:** That claims have been certified by a third party.

## 4. [`portfolio/README.md`](../README.md)

- **Why read it:** Gives the concise reviewer entry point for the portfolio package.
- **What it proves:** Reviewers have a structured path through architecture, demos, and evidence.
- **What it does not prove:** Runtime enforcement or live system security posture.

## 5. [`portfolio/evidence_index.md`](../evidence_index.md)

- **Why read it:** Maps reviewer questions to evidence and limitations.
...
- **What it does not prove:** That all risks have been remediated.
