...
|---|---|---|---|
| [`docs/security/evidence/step_39x_runtime_enforcement_proof/README.md`](../docs/security/evidence/step_39x_runtime_enforcement_proof/README.md) | Step 39X runtime enforcement proof | Documents one minimal retrieval-facing runtime hook, mode flag, allow/deny behavior, safe denial, and structured audit evidence. | Does not prove enterprise production readiness, external validation, compliance certification, live staging/cloud deployment, full Onyx-wide enforcement, or complete RAG/agent security coverage. |
